// Міст (Bridge) — це паттерн програмування, який дозволяє розмістити абстракцію і
// реалізацію в окремі класи, дозволяючи їм мати незалежний функціонал
...
class Participant {
  ...
  // Метод dispatchMessage відправляє повідомлення за допомогою
  // відповідного засобу комунікації.
...
class SMSCommunicator {
  ...
  // Він приймає один параметр - message - текст повідомлення, яке потрібно відправити,
  // та виводимо в консоль `Відправлено SMS: ${message}`.
...
class EmailCommunicator {
  ...
  // Він приймає один параметр - message - текст повідомлення, яке потрібно відправити
  // та виводимо в консоль `Відправлено Email: ${message}`.
